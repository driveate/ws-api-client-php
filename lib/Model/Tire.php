...
class Tire implements ModelInterface, ArrayAccess
{
     ...
     * Sets tire
     *
     * @param string $tire Formatted tire size (e.g. `225/55R18`)
     *
     * @return $this
     */
     ...
     * Sets width
     *
     * @param int $width Tire section width, mm (e.g. `195`)
     *
     * @return $this
     */
     ...
     * Sets aspect_ratio
     *
     * @param int $aspect_ratio Tire aspect ratio, % (e.g. `55`)
     *
     * @return $this
     */
     ...
     * Sets count
     *
     * @param int $count Number of vehicles matching tire size
     *
     * @return $this
     */
